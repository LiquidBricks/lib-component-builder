export const s = {
  INTERNALS: Symbol('BACKEND_HOST_INTERNALS'),
  IDENTITY: {
    GROUP: Symbol('BACKEND_HOST_IDENTITY_GROUP'),
    COMPONENT: Symbol('BACKEND_HOST_IDENTITY_COMPONENT'),
    AGENT_FN: Symbol('BACKEND_HOST_IDENTITY_AGENT_FN'),
    TASK: Symbol('BACKEND_HOST_IDENTITY_TASK'),
  }
}
